...
const AppConfigSchema = z
  .object({
    name: z
      .string({
        description: `This is the name of your SaaS. Ex. "Neural Defend"`,
  ...
  .refine(
    ...
    {
      message: `Please provide a valid HTTPS URL. Set the variable NEXT_PUBLIC_SITE_URL with a valid URL, such as: 'https://www.neuraldefend.com'`,
      path: ['url'],
    },
  )
  .refine(
